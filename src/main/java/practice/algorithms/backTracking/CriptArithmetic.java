...
public class CriptArithmetic {
    ...
    public static void solution(String unique, int idx,
        ...
        if(idx == unique.length()){
            int sum1 = stringToInt(charIntMap,s1);
            int sum2 = stringToInt(charIntMap,s2);
            int sum3 = stringToInt(charIntMap,s3);
            if(sum3 == sum1+sum2){
                print(charIntMap);
            }
            return;
